...
export class VocabularyService {
  ...
  async findByGerman(german: string, wordType?: WordType): Promise<Vocabulary | undefined> {
    ...
    const matchType = (v: Vocabulary) =>
      !wordType || wordType === 'unknown' || wordType === 'other' || v.wordType === wordType;
  ...
  private findByGermanInList(
    ...
    for (const candidate of candidates) {
      const inflected = list.find(
        (v) => matchType(v) && this.matchesInflectedForm(v, candidate, wordType),
      );
  ...
  private buildLookupCandidates(term: string): string[] {
    ...
    const withoutArticle = term
      .replace(/^(der|die|das|ein|eine|einen|einem|einer|eines)\s+/u, '')
      .trim();
  ...
  private matchesInflectedForm(vocab: Vocabulary, term: string, requestedType?: WordType): boolean {
    ...
    if (type === 'verb') {
      ...
      const forms = [
        ...
        vd.imperative.ihr,
        vd.imperative.Sie,
        this.extractMainVerbToken(vd.pastPerfect.ich),
        this.extractMainVerbToken(vd.pastPerfect.du),
        this.extractMainVerbToken(vd.pastPerfect.erSieEs),
        this.extractMainVerbToken(vd.pastPerfect.wir),
        this.extractMainVerbToken(vd.pastPerfect.ihr),
        this.extractMainVerbToken(vd.pastPerfect.sie),
        this.extractMainVerbToken(vd.future.ich),
        this.extractMainVerbToken(vd.future.du),
        this.extractMainVerbToken(vd.future.erSieEs),
        this.extractMainVerbToken(vd.future.wir),
        this.extractMainVerbToken(vd.future.ihr),
        this.extractMainVerbToken(vd.future.sie),
      ];
  ...
  findDuplicate(
    ...
    return this.vocabsSubject.value.find(
      (v) =>
        v._id !== excludeId && v.german.trim().toLowerCase() === term && v.wordType === wordType,
    );
  }
  ...
  async importAll(
    vocabs: Vocabulary[],
    duplicateStrategy: 'replace' | 'keep' = 'replace',
  ): Promise<number> {
  ...
  filter(
    ...
    return vocabs.filter((v) => {
      ...
      const matchSearch =
        !term || v.german.toLowerCase().includes(term) || v.english.toLowerCase().includes(term);
      return matchType && matchLevel && matchSearch;
    });
  }

  async seedSampleData(): Promise<void> {
    if (localStorage.getItem('suppress_sample_seed_v1') === 'true') {
      await this.load();
      return;
    }
    ...
    const samples: Vocabulary[] = [
      ...
      },
      {
        ...
        nounDetails: {
          ...
          deklinationUnbestimmt: {
            nominative: 'eine Schule',
            akkusativ: 'eine Schule',
            genitiv: 'einer Schule',
            dativ: 'einer Schule',
          },
        },
        createdAt: now,
      ...
      },
      {
        ...
        examples: [
          ...
          {
            german: 'Wie ist das Wetter bei euch?',
            english: 'What is the weather like where you are?',
          },
        ],
        learned: false,
        nounDetails: {
          ...
          deklinationUnbestimmt: {
            nominative: 'ein Wetter',
            akkusativ: 'ein Wetter',
            genitiv: 'eines Wetters',
            dativ: 'einem Wetter',
          },
        },
        createdAt: now,
      ...
      },
      {
        ...
        examples: [
          {
            german: 'Deutsch ist eine schöne Sprache.',
            english: 'German is a beautiful language.',
          },
        ...
        nounDetails: {
          ...
          deklinationUnbestimmt: {
            nominative: 'eine Sprache',
            akkusativ: 'eine Sprache',
            genitiv: 'einer Sprache',
            dativ: 'einer Sprache',
          },
        },
        createdAt: now,
      ...
      },
      {
        ...
        examples: [
          {
            german: 'Wir suchen eine Lösung für das Problem.',
            english: 'We are looking for a solution to the problem.',
          },
          {
            german: 'Die beste Lösung ist Kommunikation.',
            english: 'The best solution is communication.',
          },
        ],
        learned: false,
        nounDetails: {
          ...
          plural: 'Lösungen',
          deklinationBestimmt: {
            nominative: 'die Lösung',
            akkusativ: 'die Lösung',
            genitiv: 'der Lösung',
            dativ: 'der Lösung',
          },
          deklinationUnbestimmt: {
            nominative: 'eine Lösung',
            akkusativ: 'eine Lösung',
            genitiv: 'einer Lösung',
            dativ: 'einer Lösung',
          },
        },
        createdAt: now,
      ...
      // ── Verbs (5 × A1-B1) ─────────────────────────────────────────────────
      {
        ...
        examples: [
          ...
          {
            german: 'Sie lernt jeden Tag neue Wörter.',
            english: 'She learns new words every day.',
          },
        ],
        learned: false,
        verbDetails: {
      ...
      },
      {
        ...
        examples: [
          ...
          {
            german: 'Sie hat gestern ein Kleid gekauft.',
            english: 'She bought a dress yesterday.',
          },
        ],
        learned: false,
        verbDetails: {
      ...
      },
      {
        ...
        examples: [
          {
            german: 'Darf ich mich vorstellen? Ich heiße Thomas.',
            english: 'May I introduce myself? My name is Thomas.',
          },
        ...
        verbDetails: {
          ...
          simplePast: {
            ...
            du: 'stelltest dich vor',
            erSieEs: 'stellte sich vor',
      ...
      },
      {
        ...
        examples: [
          ...
          {
            german: 'Es ist wichtig, pünktlich zu sein.',
            english: 'It is important to be punctual.',
          },
        ],
        learned: false,
        adjectiveDetails: {
      ...
      },
      {
        ...
        examples: [
          ...
          {
            german: 'Es war eine schwierige Entscheidung.',
            english: 'It was a difficult decision.',
          },
        ],
        learned: false,
        adjectiveDetails: {
          ...
          deklinationMaskulin: {
            nominative: 'schwieriger',
            akkusativ: 'schwierigen',
            genitiv: 'schwierigen',
            dativ: 'schwierigem',
          },
          deklinationFeminin: {
            nominative: 'schwierige',
            akkusativ: 'schwierige',
            genitiv: 'schwieriger',
            dativ: 'schwieriger',
          },
          deklinationNeutral: {
            nominative: 'schwieriges',
            akkusativ: 'schwieriges',
            genitiv: 'schwierigen',
            dativ: 'schwierigem',
          },
          deklinationPlurar: {
      ...
      },
      {
        ...
        examples: [
          {
            german: 'Es regnet, aber wir gehen trotzdem spazieren.',
            english: 'It is raining, but we go for a walk anyway.',
          },
          {
            german: 'Er war krank, trotzdem kam er zur Arbeit.',
            english: 'He was sick; nevertheless, he came to work.',
          },
        ],
        learned: false,
        createdAt: now,
      ...
      // ── Prepositions (5 × A1-B1) ──────────────────────────────────────────
      {
        ...
        level: 'A1',
        description:
          'Expressing location inside something. Takes dative (location) or accusative (movement).',
        examples: [
      ...
      },
      {
        ...
        examples: [
          { german: 'Das Buch liegt auf dem Tisch.', english: 'The book is on the table.' },
          {
            ...
            english: 'He puts the book onto the table.',
          },
        ],
        learned: false,
        createdAt: now,
      ...
      },
      {
        ...
        examples: [
          ...
          {
            german: 'Sie geht mit ihrem Freund spazieren.',
            english: 'She goes for a walk with her friend.',
          },
        ],
        learned: false,
        createdAt: now,
      ...
      },
      {
        ...
        examples: [
          {
            german: 'Wegen des Regens blieb er zu Hause.',
            english: 'He stayed at home because of the rain.',
          },
          {
            german: 'Sie kam spät wegen des Staus.',
            english: 'She arrived late due to the traffic jam.',
          },
        ],
        learned: false,
        createdAt: now,
      ...
      },
      {
        ...
        examples: [
          ...
          {
            german: 'Er lernt Deutsch, weil er nach Deutschland will.',
            english: 'He is learning German because he wants to go to Germany.',
          },
        ],
        learned: false,
        createdAt: now,
        ...
        examples: [
          {
            ...
            english: 'Although it is raining, we go for a walk.',
          },
      ...
      },
      {
        ...
        examples: [
          ...
          {
            german: 'Gibt es jemanden, der helfen kann?',
            english: 'Is there someone who can help?',
          },
        ],
        learned: false,
        createdAt: now,
